...
#df['T_K'] = 1/df["T_K"]
#df['SiO2_Liq'] = 1/df['SiO2_Liq']**2

filtered_col = [ 'T_K', 'SiO2_Cpx', 'TiO2_Cpx',
       'Al2O3_Cpx', 'FeOt_Cpx', 'MgO_Cpx', 'MnO_Cpx', 'CaO_Cpx', 'Na2O_Cpx',
       'Cr2O3_Cpx',
       'SiO2_Liq', 'TiO2_Liq', 'Al2O3_Liq','FeOt_Liq', 'MgO_Liq', 'MnO_Liq', 'CaO_Liq', 'Na2O_Liq', 'K2O_Liq', # Liquid Comp
       ]
...
y_col = df.loc[df_filtered.index]['P_kbar']
...
one_to_one = np.arange(0,32)
ax.plot(one_to_one,one_to_one, c = "k", alpha = 0.7)
